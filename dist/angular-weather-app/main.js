...
var AppComponent = /** @class */ (function () {
    function AppComponent(weatherService) {
        ...
        this.location = { cityName: 'London', countryCode: 'uk' };
        this.weather = undefined;
    }
    AppComponent.prototype.ngOnInit = function () {
        this.getWeather(this.location.cityName, this.location.countryCode);
    };
    AppComponent.prototype.getWeather = function (cityName, countryCode) {
        var _this = this;
        this.weatherService
    ...
    AppComponent.prototype.submitLocation = function (cityName, countryCode) {
...
var WeatherService = /** @class */ (function () {
    function WeatherService(http) {
        this.http = http;
        this.apiKey = '13e631d6d0d3fe208af196e86d899747';
        this.URI = '';
...
module.exports = __webpack_require__(/*! /Users/RafaelRomero/Downloads/angular-weather-app-master/src/main.ts */"./src/main.ts");
